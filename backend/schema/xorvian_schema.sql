...
CREATE TABLE IF NOT EXISTS agent_settings (
  ...
  assistant_response_style VARCHAR(20) NOT NULL DEFAULT 'balanced',
  assistant_min_response_chars INT UNSIGNED NOT NULL DEFAULT 60,
  assistant_buffer_chars INT UNSIGNED NOT NULL DEFAULT 120,
  assistant_flush_delay_ms INT UNSIGNED NOT NULL DEFAULT 300,
  elevenlabs_streaming_latency TINYINT UNSIGNED NOT NULL DEFAULT 3,
  ...
  order_review_required TINYINT(1) NOT NULL DEFAULT 1,
  order_tax_rate DECIMAL(5,4) NOT NULL DEFAULT 0.0000,
  delivery_fee DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  pickup_lead_minutes INT UNSIGNED NOT NULL DEFAULT 20,
  delivery_lead_minutes INT UNSIGNED NOT NULL DEFAULT 45,
  catering_threshold_people INT UNSIGNED NOT NULL DEFAULT 25,
  minimum_order_amount DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  order_currency VARCHAR(8) NOT NULL DEFAULT 'CAD',
  order_sms_enabled TINYINT(1) NOT NULL DEFAULT 1,
  order_pos_provider VARCHAR(40) NOT NULL DEFAULT 'dashboard',
  order_pos_endpoint VARCHAR(255) NOT NULL DEFAULT '',
  order_kitchen_channel VARCHAR(40) NOT NULL DEFAULT 'dashboard',
...
CREATE TABLE IF NOT EXISTS menu_items (
  ...
  allergen_notes VARCHAR(255) NULL,
  is_featured TINYINT(1) NOT NULL DEFAULT 0,
  modifier_prices_json JSON NULL,
  sort_order INT UNSIGNED NOT NULL DEFAULT 0,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  order_type ENUM('pickup', 'delivery', 'catering', 'scheduled', 'asap', 'dine_in') NOT NULL DEFAULT 'pickup',
  review_status ENUM('draft', 'reviewed', 'confirmed') NOT NULL DEFAULT 'confirmed',
  ...
  duplicate_of_order_id BIGINT UNSIGNED NULL,
  parent_order_id BIGINT UNSIGNED NULL,
  estimated_ready_at DATETIME NULL,
  estimated_delivery_at DATETIME NULL,
  confirmed_at TIMESTAMP NULL,
  cancelled_at TIMESTAMP NULL,
  pos_status VARCHAR(30) NOT NULL DEFAULT 'pending',
  pos_error TEXT NULL,
  customer_sms_status VARCHAR(30) NOT NULL DEFAULT '',
  customer_sms_error TEXT NULL,
  ...
  KEY idx_orders_duplicate_hash (duplicate_hash),
  KEY idx_orders_phone (customer_phone),
  KEY idx_orders_scheduled_for (scheduled_for),
